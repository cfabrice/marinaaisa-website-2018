...
select {
  ...
  -moz-appearance: none;
  appearance: none;
  background: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='100' fill='#6C5CFF' height='100'><polygon points='0,0 100,0 50,50'/></svg>") no-repeat;
